To use `npx lite-server`, you first need to ensure that you have `lite-server` installed in your project. If you haven't installed it yet, you can do so by running the following command:
